...
@section("content")
    <div class="flex flex-col justify-center items-center space-y-2">
        @if($response["code"] == 0)
            ...
            <p class="text-lg font-semibold text-gray-800 dark:text-white text-center"><b>La cuenta se ha verificado correctamente</b></p>
        ...
        @else
            ...
            <p class="text-lg font-semibold text-gray-800 dark:text-white text-center"><b>Al parecer el link ya no era válido</b></p>
            <p class="text-gray-950 dark:text-gray-200 text-center">Prueba a volver a solicitar el correo de verificación desde la app</p>
        @endif
    </div>
@endsection
